CREATE TABLE IF NOT EXISTS users (
    ...
    full_username TEXT DEFAULT ""  -- Fully qualified username as returned by the broker; may differ from name when short usernames are enabled
);
...
CREATE INDEX "idx_user_full_username" ON users ("full_username");
