...
func (x *STBRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*STBRequest) ProtoMessage() {}

func (x *STBRequest) ProtoReflect() protoreflect.Message {
	mi := &file_authd_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use STBRequest.ProtoReflect.Descriptor instead.
func (*STBRequest) Descriptor() ([]byte, []int) {
	return file_authd_proto_rawDescGZIP(), []int{14}
}

func (x *STBRequest) GetBrokerId() string {
	if x != nil {
		return x.BrokerId
	}
	return ""
...
func (x *STBRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_authd_proto_goTypes = []any{
	...
	(*STBRequest)(nil),                     // 15: authd.STBRequest
...
var file_authd_proto_depIdxs = []int32{
	...
	15, // 15: authd.PAM.SetBroker:input_type -> authd.STBRequest
	...
	1,  // 37: authd.PAM.SetBroker:output_type -> authd.Empty
