...
var file_authd_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_authd_proto_goTypes = []any{
	...
	(*User)(nil),                           // 28: authd.User
	(*Users)(nil),                          // 29: authd.Users
	(*Group)(nil),                          // 30: authd.Group
	(*Groups)(nil),                         // 31: authd.Groups
	(*ABResponse_BrokerInfo)(nil),          // 32: authd.ABResponse.BrokerInfo
	(*GAMResponse_AuthenticationMode)(nil), // 33: authd.GAMResponse.AuthenticationMode
	(*IARequest_AuthenticationData)(nil),   // 34: authd.IARequest.AuthenticationData
}
var file_authd_proto_depIdxs = []int32{
	32, // 0: authd.ABResponse.brokers_infos:type_name -> authd.ABResponse.BrokerInfo
	0,  // 1: authd.SBRequest.mode:type_name -> authd.SessionMode
	9,  // 2: authd.GAMRequest.supported_ui_layouts:type_name -> authd.UILayout
	33, // 3: authd.GAMResponse.authentication_modes:type_name -> authd.GAMResponse.AuthenticationMode
	9,  // 4: authd.SAMResponse.ui_layout_info:type_name -> authd.UILayout
	34, // 5: authd.IARequest.authentication_data:type_name -> authd.IARequest.AuthenticationData
	28, // 6: authd.Users.users:type_name -> authd.User
	30, // 7: authd.Groups.groups:type_name -> authd.Group
	...
	28, // 35: authd.UserService.GetUserByName:output_type -> authd.User
	28, // 36: authd.UserService.GetUserByID:output_type -> authd.User
	29, // 37: authd.UserService.ListUsers:output_type -> authd.Users
	...
	1,  // 42: authd.UserService.SetShell:output_type -> authd.Empty
	30, // 43: authd.UserService.GetGroupByName:output_type -> authd.Group
	30, // 44: authd.UserService.GetGroupByID:output_type -> authd.Group
	31, // 45: authd.UserService.ListGroups:output_type -> authd.Groups
