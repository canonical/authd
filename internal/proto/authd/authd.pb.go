...
const file_authd_proto_rawDesc = "" +
	...
	"\x17SetDefaultBrokerForUser\x12\x13.authd.SDBFURequest\x1a\f.authd.Empty2\xa0\x05\n" +
	"\vUserService\x129\n" +
	...
	"\tSetUserID\x12\x17.authd.SetUserIDRequest\x1a\x18.authd.SetUserIDResponse\x126\n" +
	"\vSetUserName\x12\x19.authd.SetUserNameRequest\x1a\f.authd.Empty\x12A\n" +
	"\n" +
...
var file_authd_proto_goTypes = []any{
	...
	(*SetUserNameRequest)(nil),             // 25: authd.SetUserNameRequest
...
var file_authd_proto_depIdxs = []int32{
	...
	25, // 22: authd.UserService.SetUserName:input_type -> authd.SetUserNameRequest
	26, // 23: authd.UserService.SetGroupID:input_type -> authd.SetGroupIDRequest
	28, // 24: authd.UserService.SetShell:input_type -> authd.SetShellRequest
	21, // 25: authd.UserService.GetGroupByName:input_type -> authd.GetGroupByNameRequest
	22, // 26: authd.UserService.GetGroupByID:input_type -> authd.GetGroupByIDRequest
	...
	24, // 41: authd.UserService.SetUserID:output_type -> authd.SetUserIDResponse
	1,  // 42: authd.UserService.SetUserName:output_type -> authd.Empty
	27, // 43: authd.UserService.SetGroupID:output_type -> authd.SetGroupIDResponse
