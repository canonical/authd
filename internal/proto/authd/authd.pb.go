...
const file_authd_proto_rawDesc = "" +
	...
	"\x17SetDefaultBrokerForUser\x12\x13.authd.SDBFURequest\x1a\f.authd.Empty2\xb1\x06\n" +
	"\vUserService\x129\n" +
...
var file_authd_proto_depIdxs = []int32{
	...
	3,  // 31: authd.PAM.GetPreviousBroker:output_type -> authd.GPBResponse
	...
	1,  // 37: authd.PAM.SetDefaultBrokerForUser:output_type -> authd.Empty
