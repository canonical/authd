...
const (
	...
	PAM_ReleaseUserAlias_FullMethodName         = "/authd.PAM/ReleaseUserAlias"
...
type PAMClient interface {
	...
	ReleaseUserAlias(ctx context.Context, in *RUARequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *pAMClient) ReleaseUserAlias(ctx context.Context, in *RUARequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, PAM_ReleaseUserAlias_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PAMServer interface {
	...
	ReleaseUserAlias(context.Context, *RUARequest) (*Empty, error)
...
func (UnimplementedPAMServer) ReleaseUserAlias(context.Context, *RUARequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ReleaseUserAlias not implemented")
}
...
func _PAM_ReleaseUserAlias_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RUARequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PAMServer).ReleaseUserAlias(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PAM_ReleaseUserAlias_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PAMServer).ReleaseUserAlias(ctx, req.(*RUARequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PAM_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReleaseUserAlias",
			Handler:    _PAM_ReleaseUserAlias_Handler,
		},
		{
