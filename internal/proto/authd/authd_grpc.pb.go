...
type UserServiceClient interface {
	...
	SetUserName(ctx context.Context, in *SetUserNameRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *userServiceClient) SetUserName(ctx context.Context, in *SetUserNameRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type UserServiceServer interface {
	...
	SetUserName(context.Context, *SetUserNameRequest) (*Empty, error)
...
func (UnimplementedUserServiceServer) SetUserName(context.Context, *SetUserNameRequest) (*Empty, error) {
