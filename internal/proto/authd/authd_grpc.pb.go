...
const (
	...
	PAM_SetBroker_FullMethodName                = "/authd.PAM/SetBroker"
)
...
type PAMClient interface {
	...
	SetBroker(ctx context.Context, in *STBRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *pAMClient) SetBroker(ctx context.Context, in *STBRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, PAM_SetBroker_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PAMServer interface {
	...
	SetBroker(context.Context, *STBRequest) (*Empty, error)
...
func (UnimplementedPAMServer) SetBroker(context.Context, *STBRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method SetBroker not implemented")
}
...
func _PAM_SetBroker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(STBRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PAMServer).SetBroker(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PAM_SetBroker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PAMServer).SetBroker(ctx, req.(*STBRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PAM_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PAM_SetBroker_Handler,
		},
	},
