...
func TestNewUser(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			...
			got := info.NewUser(tc.name, tc.home, tc.providerID, tc.shell, tc.gecos, tc.groups)
			...
			require.Equal(t, tc.providerID, got.ProviderID, "ProviderID does not match the expected value")
